      ...
      createElement(
        ...
        [
          createElement(
            ...
            {
              attrs: {
                'xlink:href': '/assets/img/app-icons.svg#plus'
              }
            }
          )
        ]
      ...
      createElement(
        ...
        [
          createElement(
            ...
            {
              attrs: {
                'xlink:href': `/assets/img/app-icons.svg#${icon}`
              }
            }
          )
        ]
...
const renderNodeLabel = (createElement, node, context, parentNode) => {
  ...
  let children = [
    createElement('span', { class: { 'label': true }, attrs: { draggable: node.options.draggable } },
      [
        createElement('svg', {
          class: {
            'icon': true
        ...
        [
          createElement('use', {
            attrs: {
              'xlink:href': '/assets/img/app-icons.svg#folder'
            }
          })
        ]),
        node.options.label
